...
BACKENDS=['nv_row','nv_column','gpusim','tide_bounded','tide_unbounded']
PEERS=['nv_row','nv_column','gpusim','tide_unbounded']
...
def plan():
    ...
    for peer in PEERS:
        for pair in range(1,7):
            order=[peer,'tide_bounded'] if pair%2 else ['tide_bounded',peer]
