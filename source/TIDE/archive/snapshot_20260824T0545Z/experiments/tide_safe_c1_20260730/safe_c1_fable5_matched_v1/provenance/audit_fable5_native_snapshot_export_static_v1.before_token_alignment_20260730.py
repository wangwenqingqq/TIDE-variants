    ...
    try:
        ...
        if exporter.is_file():
            ...
            for name, token in {
                ...
                'frozen_hash_export': 'frozen_tree_fnv1a64',
                ...
                'mode_zero_provenance': '"residual_pruning": {"mode":0',
                'no_query_export_claim': '"query_executed":false',
        ...
        if selector.is_file():
            ...
            for name, token in {
                ...
                'snapshot_hash_recompute': 'frozen_tree_hash_mismatch',
                ...
                'runtime_receipt_requirement': 'native traversal receipt visits direct_leaf',
        ...
        if guard.is_file():
            ...
            for name, token in {
                ...
                'no_process_termination': 'never terminates processes',
        ...
        if manifest.is_file():
            ...
            checks['manifest_static_boundary'] = m.get('execution_boundary', {}).get('compiled') is False and m.get('execution_boundary', {}).get('gpu_used') is False
            ...
            for name in ('manifest_schema', 'manifest_static_boundary', 'manifest_mode_zero', 'manifest_no_c2c3'):
                if not checks[name]:
