// Isolated C1 source-level allocator counter integrated through update.cuh.
// C1-relevant workspace cudaMalloc/cudaMallocManaged/cudaFree calls in this
// copied worktree use the C1_* wrappers below; archive source files remain unchanged.
// Counters are provenance diagnostics, not a substitute for Nsight profiling.
#pragma once
