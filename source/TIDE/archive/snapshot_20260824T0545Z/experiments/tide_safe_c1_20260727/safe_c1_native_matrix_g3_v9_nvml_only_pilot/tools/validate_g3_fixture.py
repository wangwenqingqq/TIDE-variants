...
def validate_engine(bundle: Path, engine_path: Path) -> dict[str, Any]:
    ...
    return {
        "schema": "safe-c1-g3-native-validator-v5-ticket-diagnostics-p0",
        "status": "PASS" if not errors else "FAIL",
        "gpu_used": False,
        "scope": "independent CPU validation of a future receipt schema only; no native execution, native correctness result, independent-oracle provenance result, or performance claim",
        "bundle": str(bundle),
