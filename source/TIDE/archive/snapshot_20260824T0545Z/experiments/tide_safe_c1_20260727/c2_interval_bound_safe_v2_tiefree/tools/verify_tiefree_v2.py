...
def main() -> int:
    ...
    need(split.get("selection_audit_path") == protocol.get("tie_free_v2", {}).get("selection_audit_path"), "protocol split/tie-free selection-audit path alias mismatch", failures)
    need(split.get("selection_audit_sha256") == protocol.get("tie_free_v2", {}).get("selection_audit_sha256"), "protocol split/tie-free selection-audit SHA alias mismatch", failures)
