...
constexpr char kReleaseRoot[] =
    ...
    "safe_c1_native_matrix_g3_v17_json_receiptfix_preflightroot";
...
int main(int argc, char** argv) {
  ...
  try {
    ...
    if (argc == 2 && std::string_view(argv[1]) == "--self-test-receipt-json") {
      ...
      std::cout << "V16_RECEIPT_JSON_SELF_TEST_OK\n";
      return 0;
    }
    ...
    std::cout << "V16_FROZEN_SNAPSHOT_CERTIFICATE_DIAGNOSTIC_OK\n";
    return 0;
