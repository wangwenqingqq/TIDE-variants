#!/usr/bin/env bash
set -Eeuo pipefail
OUT="/workspace/experiments/tide_safe_c1_20260727/c2_speculative_fallback_v4/formal_runs/c2_v4_calibration_v1"
READY="/workspace/experiments/tide_safe_c1_20260727/c2_speculative_fallback_v4/formal_runs/c2_v4_calibration_v1/child.ready"
pid=$$
...
exec env CUDA_VISIBLE_DEVICES=0 "/workspace/experiments/tide_safe_c1_20260727/c2_speculative_fallback_v4/bin/GTS_safe_c2_speculative_fallback_v4_sift1m" --mode calibrate \
  ...
  --query-ids "/workspace/experiments/tide_safe_c1_20260727/c2_speculative_fallback_v4/inputs/final_workload_v2/calibration.ids" --out "$OUT" --stage calibration \
  --workload-manifest "/workspace/experiments/tide_safe_c1_20260727/c2_speculative_fallback_v4/inputs/final_workload_v2/workload_manifest.json" --warmup-reps 0 --timed-reps 1
