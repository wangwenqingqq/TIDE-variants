...
constexpr char kReleaseRoot[] =
    ...
    "safe_c1_native_matrix_g3_v23_fulltrace_nativecertfix_jsonseal";
...
constexpr ExpectedFile kBootstrapFiles[] = {
    ...
    {"bootstrap_oracle_validation.json",
     "11a652295507b138d3f0e8b460c7b7b055c82905b8157087a6170673a7af998e", 0},
};
...
int main(int argc, char** argv) {
  ...
  try {
    ...
    std::cout << "V23_SAFE_C1_FULLTRACE_GATE_OK\n";
    return 0;
