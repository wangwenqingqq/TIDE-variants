#!/usr/bin/env python3
"""Atomic, CPU-only provenance manifest utility for C1 v8."""
from __future__ import annotations
import argparse, hashlib, json, os, pathlib, platform, subprocess, sys
from datetime import datetime, timezone
from typing import Any

MANIFEST_NAME="run_manifest_v8.json"
...
def init(a:argparse.Namespace)->None:
    ...
    if launcher != root/"launch_c1_v8.sh": raise SystemExit("launcher must be canonical v8 trust-root path")
    ...
    obj={"schema":"gtspp-c1-v8-run-manifest-v2","created_utc":utc(),"updated_utc":utc(),"status":"PREPARED",
