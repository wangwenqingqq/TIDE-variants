#!/usr/bin/env python3
"""CPU-only regression fixtures for the v7 C1 capacity snapshot repair.
...
ROOT = pathlib.Path("/workspace/experiments/tide_safe_c1_20260727/c1_workspace_onequery_microbenchmark_v7_profile_manifest_repair")
...
def main() -> int:
    contract = load_module("capacity_snapshot_contract_v7", ROOT / "capacity_snapshot_contract_v7.py")
    source = load_module("verify_v7_source_pins", ROOT / "verify_v7_source_pins.py")
