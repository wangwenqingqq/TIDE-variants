...
def static_policy(root: pathlib.Path, pins: dict[str, Any]) -> None:
    ...
    for token in ("assert_capacity_snapshot_source_policy", "global update_result_ws_cap read after release", "capacity_snapshot_stage", "profile_manifest_fixture", "profile_terminal_fixture"):
