...
def static_source_policy(root:pathlib.Path)->None:
    ...
    for label,fixture_path in (("profile-manifest",profile_manifest_fixture),("profile-terminal",profile_terminal_fixture),("guard-session-ownership-and-manifest-race",guard_session_fixture)):
