...
# --verify-static is CPU-only: it never invokes nvidia-smi or a CUDA workload.
set -uo pipefail
umask 077
...
PINS="$ROOT/hardened_static_pins_v1.json"
EXPECTED_PINS_SHA='6bed108769444394855545a8a6e4dbde27e53c6503d9da5e23ff968b54612332'
...
assert p['schema']=='gtspp-c1-hardened-static-pins-v1'
