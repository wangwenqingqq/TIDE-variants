#!/usr/bin/env python3
"""Create the complete CPU-only C1 v5 integrity pin set after a successful build."""
...
HELPER_PATHS={
    "guard":"run_c1_workspace_microbenchmark_guard_v5.sh",
    "measured_engine":"run_c1_four_variants_v5.sh",
    "profile_engine":"run_c1_profile_primary_v5.sh",
    "profile_guard":"run_c1_profile_guard_v5.sh",
    "profile_manifest_utility":"c1_v5_profile_manifest.py",
    "strict_semantic_verifier":"verify_c1_semantics_v5.py",
    "measured_analyzer":"analyze_c1_microbenchmark_v5.py",
    "profile_verifier":"verify_c1_profile_artifacts_v5.py",
    "measured_finalizer":"finalize_c1_evidence_v5.py",
    "formal_aggregator":"aggregate_c1_formal_evidence_v5.py",
    "manifest_utility":"c1_v5_manifest.py",
    "pin_verifier":"verify_v5_pins.py",
    "pin_generator":"create_v5_pins.py",
    "build_script":"build_v5_variants.sh",
    "build_manifest_creator":"create_v5_build_manifest.py",
}
PROTOCOL_PATHS={
    "formal_supersession":"protocol_c1_v5_formal_supersession_v1.json",
    "frozen_protocol":"protocol_c1_workspace_onequery_sift1m_v1_frozen_copy.json",
    "gpu_uuid_safety":"protocol_c1_gpu_uuid_safety_supersession_v1_frozen_copy.json",
    "idle_poll_safety":"protocol_c1_gpu_idle_poll_safety_supersession_v1_frozen_copy.json",
    "idle_poll_logdir":"protocol_c1_gpu_idle_poll_logdir_fix_v1_frozen_copy.json",
    "implementation_correction":"implementation_correction_ephemeral_workspace_null_v1_frozen_copy.json",
    "execution_plan":"measured_execution_plan_v5.json",
    "profile_execution_plan":"profile_execution_plan_v5.json",
}
...
def validate_v5_trace_provenance(inputs:dict,protocols:dict)->None:
...
def validate_profile_execution_plan(protocols:dict)->None:
    ...
    if plan.get("schema")!="gtspp-c1-v5-profile-execution-plan-v1": raise SystemExit("profile plan schema")
    ...
    if nsys.get("artifact_layout",{}).get("csv_reports")!=["nsys/reports/profile_"+x+".csv" for x in reports]: raise SystemExit("profile plan artifact layout")
...
def main()->None:
    ...
    build=root/"worktree_build_manifest_v5.json"
    ...
    validate_v5_trace_provenance(inputs,protocols)
    ...
    out={
        "schema":"gtspp-c1-v5-pins-v1",
        "created_utc":datetime.now(timezone.utc).isoformat(),
        "root":str(root),
        "scope":"All v5 C1 artifacts pinned after CPU/NVCC compilation only; no CUDA binary, nsys, nvidia-smi, or GPU workload executed.",
    ...
    target=a.out or root/"hardened_static_pins_v5.json"
