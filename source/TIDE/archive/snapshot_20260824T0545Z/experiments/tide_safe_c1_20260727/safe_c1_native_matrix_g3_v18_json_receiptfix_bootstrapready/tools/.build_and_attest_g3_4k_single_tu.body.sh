...
set -euo pipefail
umask 077
ROOT="/workspace/experiments/tide_safe_c1_20260727/safe_c1_native_matrix_g3_v18_json_receiptfix_bootstrapready"
...
SOURCE_DESCRIPTOR_SHA="f9aacdd7366e8f4c1f41c3ab5dcd9fc63fed23e34277fb4b5f77b3d2867dc9d2"
WRAPPER_SHA="ccbdc56c8ed2f349bce95bce2254cee88eb657c1a8d6c11121235ccb4fb856f9"
...
source_closure_descriptor() {
  {
    ...
    printf '%s\n' \
      'src/g3_safe_c1_native_matrix.cu:b2a334711339c7dbd6d23e15d0d9c6ade6572da6aa31932846c36ab48e11d74a' \
...
snapshot_file "b2a334711339c7dbd6d23e15d0d9c6ade6572da6aa31932846c36ab48e11d74a" "src/g3_safe_c1_native_matrix.cu"
...
expect_sha "b2a334711339c7dbd6d23e15d0d9c6ade6572da6aa31932846c36ab48e11d74a" "$COMPILE_SNAPSHOT/src/g3_safe_c1_native_matrix.cu"
...
# CPU-only strict JSON grammar self-test.  It reaches no Matrix/CUDA entry,
# requires no token/NVML state, and specifically rejects the v15 missing-]
# candidates-array terminator before a GPU admission can be published.
JSON_SELF_TEST="$ADMISSION.receipt-json-self-test.txt"
clean_tool "$BINARY" --self-test-receipt-json >"$JSON_SELF_TEST"
grep -Fx 'V18_RECEIPT_JSON_SELF_TEST_OK' "$JSON_SELF_TEST" >/dev/null ||
  { echo "receipt JSON self-test marker mismatch" >&2; exit 69; }
[[ "$(/usr/bin/wc -l <"$JSON_SELF_TEST")" -eq 1 ]] ||
  { echo "receipt JSON self-test emitted unexpected extra output" >&2; exit 69; }
