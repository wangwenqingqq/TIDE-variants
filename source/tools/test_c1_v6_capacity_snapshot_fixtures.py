#!/usr/bin/env python3
"""CPU-only regression fixtures for the v6 C1 capacity snapshot repair.
...
ROOT = pathlib.Path("/workspace/experiments/tide_safe_c1_20260727/c1_workspace_onequery_microbenchmark_v6_capacity_snapshot")
...
def main() -> int:
    contract = load_module("capacity_snapshot_contract_v6", ROOT / "capacity_snapshot_contract_v6.py")
    source = load_module("verify_v6_source_pins", ROOT / "verify_v6_source_pins.py")
