...
RUNNER_FREEZE=ROOT/"provenance/static_aabb_heldout_perf_evidence_runner_freeze_v2.json"
GPU_INDEX=0
...
def main()->int:
 ...
 try:
  ...
  atomic(terminal,{"schema":"safe-c2-static-aabb-heldout-perf-terminal-v1","status":"FAILED","batch_id":batch_id,"finished_utc":utc(),"exit_code":2,"formal_claim_eligible":False,"error":str(e),"traceback":traceback.format_exc()})
