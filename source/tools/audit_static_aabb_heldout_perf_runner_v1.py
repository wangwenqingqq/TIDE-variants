...
RUNNER=ROOT/"tools/run_static_aabb_heldout_perf_evidence_v1.py"
FREEZE=ROOT/"provenance/static_aabb_heldout_perf_evidence_runner_freeze_v1.json"
PREFLIGHT=ROOT/"provenance/static_aabb_heldout_perf_evidence_runner_preflight_v1.json"
PROTOCOL=ROOT/"provenance/static_aabb_heldout_perf_evidence_protocol_v1.json"
EXPECTED={
 "runner":"6e07c164276016fd20663301b6d1021e1c36ef5c5a4582b7f1c548311c29c16b",
 "freeze":"3da769324850942dd133ed83a52a8931e4b4247d687f39d13ee510c6dcba0423",
...
def main()->int:
 ...
 if freeze.get("schema")!="safe-c2-static-aabb-heldout-perf-runner-freeze-v1" or freeze.get("status")!="FROZEN_CPU_ONLY":
 ...
 out={
  "schema":"safe-c2-static-aabb-heldout-perf-runner-audit-v1",
...
if __name__=="__main__":
 try:
  ...
  print("FAIL_STATIC_AABB_HELDOUT_PERF_RUNNER_AUDIT_V1: "+str(e),file=sys.stderr)
  raise SystemExit(2)
