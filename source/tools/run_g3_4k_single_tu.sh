#!/bin/sh
# The only supported entry point for the guarded native pilot body.
...
TOOLS="$ROOT/tools"
BODY="$TOOLS/.run_g3_4k_single_tu.body.sh"
EXPECTED_BODY_SHA256="c3be64dc53414feab4f2125482fd43e85ed6f671b6f4cbd94bad601027f45fc8"
