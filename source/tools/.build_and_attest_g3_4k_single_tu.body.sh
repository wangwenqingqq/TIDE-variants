...
set -euo pipefail
umask 077
ROOT="/workspace/experiments/tide_safe_c1_20260727/safe_c1_native_matrix_g3_v17_json_receiptfix_preflightroot"
...
WRAPPER_SHA="66bb22d74ea5069b1ba4241b6d76e4e4d40f5ee8e018fce57aa94fdc8c00f9fd"
...
grep -Fx 'V16_RECEIPT_JSON_SELF_TEST_OK' "$JSON_SELF_TEST" >/dev/null ||
