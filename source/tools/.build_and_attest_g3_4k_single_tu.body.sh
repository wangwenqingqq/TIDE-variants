...
set -euo pipefail
umask 077
ROOT="/workspace/experiments/tide_safe_c1_20260727/safe_c1_native_matrix_g3_v7_compilefix_pilot"
...
WRAPPER_SHA="b3c7c2364ee75b0869ac225a17c22d3fe1a4759d34f0eab1fda37080cf8f8909"
...
printf '%s\n' \
  "schema=safe-c1-g3-single-tu-admission-v3" "binary_path=$BINARY" \
