#!/usr/bin/env python3
"""Real CPU-only session/terminal-state fixtures for both C1-v8 outer guards.
...
CASES = (
    {
        ...
        "manifest": "run_manifest_v8.json",
        "card": "guard_run_card_v8.json",
        "variant": pathlib.Path("rep1") / "E_G_c1_off_reference",
        "schema": "gtspp-c1-v8-run-manifest-v2",
    },
    {
        "name": "profile",
        "guard": "run_c1_profile_guard_v8.sh",
        "manifest": "profile_run_manifest_v8.json",
        "card": "profile_guard_card_v8.json",
...
def run_case(root: pathlib.Path, case: dict, mode: str) -> None:
    ...
    with tempfile.TemporaryDirectory(prefix=f"c1_v8_{case['name']}_owned_session_", dir="/tmp") as raw:
