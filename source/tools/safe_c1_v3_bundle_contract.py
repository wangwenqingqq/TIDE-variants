"""CPU-only bounded-tie witness preflight shared by Safe-C1 G1B v3.
...
CURRENT_RUNNER_STABLE_ID_LAYOUT_MODE = "explicit_identity_only_current_v3_runner"
...
def load_current_runner_identity_stable_id_layout(
    ...
    """Load the stable-ID layout accepted by the current v3 CUDA runner.
...
def validate_tie_free_witness(
    ...
    return {
        "schema": "safe-c1-g1b-v3-tie-free-witness-preflight",
