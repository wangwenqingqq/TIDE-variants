  ...
  [[nodiscard]] FrozenCertificateDiagnostic inspect_initial_frozen_certificate(
    ...
    try {
      ...
      const auto require_raw_predicate_cross_check =
          [](FrozenCertificateDiagnostic* value) {
            require(value != nullptr, "null frozen certificate diagnostic");
            ...
            for (std::size_t level_index = 0;
              ...
              require(level_index < value->levels.size(),
              ...
              require(raw.diagnostic_strict_match_count == 1,
              ...
              require(found != raw.siblings.end(),
            ...
            if (certificate.failure_reason == "native_sibling_gap_or_boundary" ||
              ...
              require(certificate.failure_level >= 0 &&
                          static_cast<std::size_t>(certificate.failure_level) <
                              value->levels.size(),
                      "raw frozen predicate omits certificate failure level");
              require(value->levels[static_cast<std::size_t>(certificate.failure_level)]
