...
constexpr char kReleaseRoot[] =
    ...
    "safe_c1_native_matrix_g3_v15_frozen_snapshot_certificate_diag_evidencefix_compilefix";
...
int main(int argc, char** argv) {
  ...
  try {
    ...
    receipt << "{\"schema\":\"safe-c1-g3-native-snapshot-certificate-diagnostic-v1\""
    ...
    g3_4k_pilot::write_text_file(receipt_tmp, receipt.str());
    ...
    std::cout << "V15_FROZEN_SNAPSHOT_CERTIFICATE_DIAGNOSTIC_OK\n";
    return 0;
