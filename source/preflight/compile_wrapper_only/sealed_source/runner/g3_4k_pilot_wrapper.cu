...
constexpr char kReleaseRoot[] =
    ...
    "safe_c1_native_matrix_g3_v11_range_safe_fallback_pilot";
...
void require_range_safe_fallback_contract(
  ...
  const std::vector<StableDistance> delta_expected =
      exact_oracle(fixture, delta, query_id, /*is_knn=*/false, 0, radius_sq);
