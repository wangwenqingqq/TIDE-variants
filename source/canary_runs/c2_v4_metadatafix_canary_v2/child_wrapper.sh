#!/usr/bin/env bash
set -Eeuo pipefail
OUT="/workspace/experiments/tide_safe_c1_20260727/c2_speculative_fallback_v4/canary_runs/c2_v4_metadatafix_canary_v2"
READY="/workspace/experiments/tide_safe_c1_20260727/c2_speculative_fallback_v4/canary_runs/c2_v4_metadatafix_canary_v2/child.ready"
pid=$$
