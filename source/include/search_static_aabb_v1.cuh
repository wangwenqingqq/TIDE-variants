...
// Static Safe-C2-AABB v1 node decision. It retains only certified radial
...
void searchIndexKnnStaticAabbV1(short *data_d, TN *node_list, int *id_list, int *max_node_num, float *query_data,
