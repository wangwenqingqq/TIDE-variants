...
def cmd_run(args: argparse.Namespace) -> None:
    ...
    if scope not in {"development_smoke_only", "development_calibration_only"}:
    ...
    summary = {
        ...
        "status": ("PASS_DEVELOPMENT_SMOKE" if scope == "development_smoke_only" else "PASS_DEVELOPMENT_CALIBRATION") if failure is None else "FAIL_VISIBILITY",
...
def main() -> None:
    ...
    make.add_argument("--scope", choices=("development_smoke_only", "development_calibration_only"), default="development_smoke_only")
