...
constexpr char kReleaseRoot[] =
    ...
    "safe_c1_native_matrix_g3_v14_frozen_snapshot_certificate_diag_evidencefix";
...
constexpr ExpectedFile kSourceClosure[] = {
    {"src/g3_safe_c1_native_matrix.cu",
     "b70db5877b161199354ec6401c7806b0f6870f248c16b2b7457b9a627b56904b", 0},
...
int main(int argc, char** argv) {
  ...
  try {
    ...
    std::cout << "V13_FROZEN_SNAPSHOT_CERTIFICATE_DIAGNOSTIC_OK\n";
    return 0;
