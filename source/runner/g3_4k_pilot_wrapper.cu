...
constexpr char kReleaseRoot[] =
    ...
    "safe_c1_native_matrix_g3_v22_fulltrace_nativecertfix_jsonseal";
...
constexpr ExpectedFile kBootstrapFiles[] = {
    ...
    {"bootstrap_oracle_validation.json",
     "ab0b8a6824c1c456bf381c48110e1cf6b90654ac486fb76e133552bbcb28173d", 0},
};
...
int main(int argc, char** argv) {
  ...
  try {
    ...
    std::cout << "V22_SAFE_C1_FULLTRACE_GATE_OK\n";
    return 0;
