#!/usr/bin/env python3
"""Source-only D0 local-ext4 control plane v3: prepare a ledger or issue one claimed auth.
...
# D0 seed and authorization-ID _kernel_random_exact draws. It is deliberately not a 32-hex authorization filename, so selector v6
...
CONTROL_PLANE_ROOT = "/workspace/tide_d0_control_plane_v3_claimterminalwording_sourceonly_20260809T120000CST"
CONTROL_PLANE_CONTRACT_PATH = CONTROL_PLANE_ROOT + "/metadata/CONTROL_PLANE_CONTRACT.md"
CONTROL_PLANE_CONTRACT_SHA256 = "3bd9a69c2f000bb1d986518e968892ee2d2197b28495f698a4ce8e2534f533ee"
...
def issue_authorization(external_approval_id: str, intended_output_root: str) -> dict[str, Any]:
    """Persist the fixed claim before this control plane's D0 seed/authorization-ID draws, then issue one v6-compatible local authorization."""
    _require_linux_uid_1001()
    _validate_control_plane_contract()
